      ...
      <Row>
        ...
        <Col lg={6} md={6} sm={12} xs={12} className="product-container">
          ...
          <Row>
            ...
            <Col lg={4} md={12} sm={12} xs={12} className="text-lg-end text-xs-start">
              <p>
          ...
          <div className="product-main-sizes">
            <div className="tooltip-custom">
              ...
              <span className="tooltiptext-custom">
                <table className="sizeChart" border="0" cellpadding="10" cellspacing="0">
                  <thead>
          ...
          <Row>
            <Col className="mt-1">
              <input type="radio" className="btn-check" name="size" id="sizeS" autoComplete="on" />
              <label className="btn btn-outline-primary" htmlFor="sizeS">
                S
              </label>
            </Col>
            <Col className="mt-1">
              <input type="radio" className="btn-check" name="size" id="sizeM" autoComplete="off" />
              <label className="btn btn-outline-primary" htmlFor="sizeM">
                M
              </label>
            </Col>
            <Col className="mt-1">
              <input type="radio" className="btn-check" name="size" id="sizeL" autoComplete="off" />
              <label className="btn btn-outline-primary" htmlFor="sizeL">
                L
              </label>
            </Col>
            <Col className="mt-1">
              <input type="radio" className="btn-check" name="size" id="sizeXL" autoComplete="off" />
              <label className="btn btn-outline-primary" htmlFor="sizeXL">
                XL
              </label>
            </Col>
            <Col className="mt-1">
              <input type="radio" className="btn-check" name="size" id="size2XL" autoComplete="off" />
          ...
          <div className="buy-button mt-3">
            <Button variant="primary">
              <svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 -960 960 960" width="24">
                <path d="M280-80q-33 0-56.5-23.5T200-160q0-33 23.5-56.5T280-240q33 0 56.5 23.5T360-160q0 33-23.5 56.5T280-80Zm400 0q-33 0-56.5-23.5T600-160q0-33 23.5-56.5T680-240q33 0 56.5 23.5T760-160q0 33-23.5 56.5T680-80ZM246-720l96 200h280l110-200H246Zm-38-80h590q23 0 35 20.5t1 41.5L692-482q-11 20-29.5 31T622-440H324l-44 80h480v80H280q-45 0-68-39.5t-2-78.5l54-98-144-304H40v-80h130l38 80Zm134 280h280-280Z" fill="white"/>
              </svg>{' '}
              Buy Now • £XX.XX
            </Button>
          </div>
          ...
          <div className="under-atc mt-2">
            ...
            <div className="fabric-details-box-product-page mt-2">
              <p>Fabric Details</p>
              <img src="fabric-features.png" alt="Fabric Features" width="100%" />
            </div>
            {/* Accordion */}
              ...
              <div className="accordion-item">
                ...
                <div id="collapseOne" className="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordion">
                  <div className="accordion-body">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos accusamus itaque dicta facilis repellendus ad aliquam iusto tenetur unde quidem?
                  </div>
                </div>
              </div>
              {/* Care Instructions */}
            ...
            <div className="accordion-item" style={{ backgroundColor: "#F7F8F9" }}>
                <h2 className="accordion-header last-button" id="headingFour">
                    ...
                    <div className="row">
                        ...
                        <p>Unsure about size? Try a few on at home with <a href="#">free returns & exchanges</a></p>
                        </div>
                    </div>
                    </button>
                </h2>
