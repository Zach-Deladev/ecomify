...
const ProductPage = () => {
  ...
  // Extract and format compare at price if available
  const formattedCompareAtPrice = productPrice.compare_at_price ?
    new Intl.NumberFormat("en-GB", {
      style: "currency",
      currency: "GBP",
    }).format(productPrice.compare_at_price / 100) :
    null;
  
  // Accessing compare at price from productPrice
  const compareAtPrice = productPrice.compare_at_price;
    ...
    <div className="main-product-section">
      <Row noGutters={true}>
        ...
        <Col lg={6} md={6} sm={12} xs={12} className="product-container">
          ...
          <Row>
            <Col lg={7} md={7} sm={12} xs={12} className="product-price-row">
              <p>
              <span className="compare-at-price price">£{compareAtPrice}</span>
                <span className="sale-price price">{formattedPrice}</span>
              </p>
            </Col>
            <Col
              lg={5}
          ...
          <div className="buy-button mt-3">
            <Button onClick={handleCreateCheckoutSession} variant="primary">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="30"
                viewBox="0 -960 960 960"
                width="24"
                style={{ marginRight: "5px" }} // Add margin between the icon and text
              >
                <path
